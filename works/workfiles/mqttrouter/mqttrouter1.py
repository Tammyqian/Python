...
oclient = None
class MQTTClass:
    def __init__(self, clientid=None, host='localhost', port=1883, topic="$SYS/#" ,qos=QOS):
        self._host = host
        self._port = port
        self._topic = topic
        self._qos = qos
    ...
    def mqtt_sub(self, topic="$SYS/#", qos=QOS):
        self._mqttc.subscribe(topic, qos)

    def mqtt_pub(self, msg, topic=TOPIC):
...
class M3(MQTTClass):
    def mqtt_on_connect(self, mqttc, obj, flags, rc, topic=TOPIC):
